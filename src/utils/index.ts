...
export const appleImg = apple.src;
export const searchImg = search.src;
export const bagImg = bag.src;
export const watchImg = watch.src;
export const rightImg = right.src;
export const replayImg = replay.src;
export const playImg = play.src;
export const pauseImg = pause.src;

export const yellowImg = yellow.src;
export const blueImg = blue.src;
export const whiteImg = white.src;
export const blackImg = black.src;
export const explore1Img = explore1.src;
export const explore2Img = explore2.src;
export const chipImg = chip.src;
export const frameImg = frame.src;